...
class DayConsumption(db.Model):
    ...
    want_share = db.Column(db.Boolean, default=False)                 # Booléen indiquant si l'utilisateur souhaite partager son menu
    shared_id = db.Column(db.String(100), default="")           # identifiant du partage
    def __repr__(self):
